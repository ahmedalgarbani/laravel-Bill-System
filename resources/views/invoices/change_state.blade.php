...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoice.change_state') }}" method="post" enctype="multipart/form-data"
                          autocomplete="off">
                        @method('POST')
                        @csrf
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="Amount_Commission" class="form-control form-control-lg" id="Amount_Commission"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" value="{{date('Y-m-d')}}" name="Payment_Date" placeholder="YYYY-MM-DD"
                                       type="text" required>
                            </div>
