				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoices_partialpaid') }}">الفواتير المدفوعه جزئيا</a></li>
                                @endcan
                                @can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invoices_archive') }}">الفواتير المؤرشفه </a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='invoices_report') }}">تقارير الفوتير</a></li>
